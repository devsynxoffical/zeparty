...
class _LoginScreenState extends State<LoginScreen> with SingleTickerProviderStateMixin {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: isDark ? AppColors.cardBlack : AppColors.white,
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              TextFormField(
                                ...
                                validator: (val) {
                                  if (val == null || val.trim().isEmpty) return 'Enter username or email';
                                  return null;
                                },
                              ...
                              Align(
                                ...
                                child: TextButton(
                                  ...
                                  child: Text('Forgot Password?', style: TextStyle(color: AppColors.getPrimary(isDark), fontSize: 13)),
                                ),
                              ),
                      ...
                      // ── Google Login — Elevated (same height as Sign In) ──
                      _buildSocialButton(
                        context,
                        id: 'btn_google_login',
                      ...
                      // ── Apple Login — Elevated (same height as Sign In) ──
                      _buildSocialButton(
                        context,
                        id: 'btn_apple_login',
                        label: 'Continue with Apple',
                        icon: Icon(Icons.apple_rounded, size: 22, color: isDark ? Colors.white : Colors.black),
                        isDark: isDark,
                        onPressed: () async {
                          final auth = context.read<AuthProvider>();
                          final navigator = Navigator.of(context);
                          final success = await auth.login('apple_user@icloud.com', 'apple_token');
                          if (mounted && success) {
                            navigator.pushAndRemoveUntil(
                              PageRouteBuilder(
                                transitionDuration: const Duration(milliseconds: 400),
                      ...
                      OutlinedButton.icon(
                        ...
                        onPressed: () {
                          Navigator.push(context, MaterialPageRoute(builder: (c) => const PhoneLoginScreen()));
                        },
                      ),
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () {
                             ...
                             child: Text(
                              'Sign Up',
                              style: TextStyle(color: AppColors.getPrimary(isDark), fontWeight: FontWeight.bold),
                            ),
                          ),
                        ],
                      ),
  ...
  // ── Elevated Social Button Helper (same 52px height as Sign In) ──
